...
#ifndef __UUV_GAZEBO_PLUGINS_FLIPPER_PLUGIN_HH__
#define __UUV_GAZEBO_PLUGINS_FLIPPER_PLUGIN_HH__
...
class FlipperPlugin : public ModelPlugin
{
    /// \brief Constructor
    public: FlipperPlugin();

    /// \brief Destructor
    public: virtual ~FlipperPlugin();
    ...
    /// \brief Reads current force topic
    /*protected: void UpdateForce(ConstVector3dPtr &_msg);*/
    ...
    /// \brief Subscriber to the force topic.
/*    protected: transport::SubscriberPtr forceSubscriber;*/
