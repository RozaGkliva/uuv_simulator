...
#include <uuv_gazebo_plugins/FlipperPlugin.hh>
...
GZ_REGISTER_MODEL_PLUGIN(gazebo::FlipperPlugin)

namespace gazebo {

/////////////////////////////////////////////////
FlipperPlugin::FlipperPlugin() : inputCommand(0), angle(0), finID(-1)
{
}
...
/////////////////////////////////////////////////
void FlipperPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  this->currentSubscriber = this->node->Subscribe(currentVelocityTopic,
    &FlipperPlugin::UpdateCurrentVelocity, this);
  ...
  this->commandSubscriber = this->node->Subscribe(inputTopic,
                                                &FlipperPlugin::UpdateInput,
                                                this);

 /* // Subscribe to force input
  this->forceSubscriber = this->node->Subscribe(wrenchTopic,
                                                &FlipperPlugin::UpdateForce,
                                                this);*/

  // Connect the update event
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
        boost::bind(&FlipperPlugin::OnUpdate,
                    this, _1));
}

/////////////////////////////////////////////////
void FlipperPlugin::Init()
{
}

/////////////////////////////////////////////////
void FlipperPlugin::OnUpdate(const common::UpdateInfo &_info)
{
  ...
  /*this->angle = this->inputCommand;*/

  // Apply new fin angle. Do this last since this sets link's velocity to zero.
  this->joint->SetPosition(0, this->inputCommand);

  this->angleStamp = _info.simTime;
}

/////////////////////////////////////////////////
void FlipperPlugin::UpdateInput(ConstDoublePtr &_msg)
{
  this->inputCommand = _msg->value();
}

/*void FlipperPlugin::UpdateForce(ConstVector3dPtr &_msg)
{
  this->finForce.X() = _msg->x();
  this->finForce.Y() = _msg->y();
  this->finForce.Z() = _msg->z();
}*/

/////////////////////////////////////////////////
void FlipperPlugin::UpdateCurrentVelocity(ConstVector3dPtr &_msg)
{
