...
#ifndef __FLIPPER_ROS_PLUGIN_HH__
#define __FLIPPER_ROS_PLUGIN_HH__
...
{
  class FlipperROSPlugin : public gazebo::FlipperPlugin
  {
    /// \brief Constrcutor.
    public: FlipperROSPlugin();
    ...
    /// \brief Subscriber reacting to new pos reference set points.
    private: ros::Subscriber subReference;

    /// \brief Subscriber reacting to new force reference
    private: ros::Subscriber subForce;
