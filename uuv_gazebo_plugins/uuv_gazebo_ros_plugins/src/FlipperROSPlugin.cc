...
#include <uuv_gazebo_ros_plugins/FlipperROSPlugin.hh>
...
{
/////////////////////////////////////////////////
FlipperROSPlugin::FlipperROSPlugin()
{
...
/////////////////////////////////////////////////
/*void FlipperROSPlugin::SetForce(
    const geometry_msgs::WrenchStamped::ConstPtr &_msg)
{

  this->finForce.X() = _msg->wrench.force.x;
  this->finForce.Y() = _msg->wrench.force.y;
  this->finForce.Z() = _msg->wrench.force.z;
}*/

/////////////////////////////////////////////////
gazebo::common::Time FlipperROSPlugin::GetRosPublishPeriod()
{
  return this->rosPublishPeriod;
}

/////////////////////////////////////////////////
void FlipperROSPlugin::SetRosPublishRate(double _hz)
{
  if (_hz > 0.0)
...
/////////////////////////////////////////////////
void FlipperROSPlugin::Init()
{
  FlipperPlugin::Init();
}

/////////////////////////////////////////////////
void FlipperROSPlugin::Reset()
{
  this->lastRosPublishTime.Set(0, 0);
}

/////////////////////////////////////////////////
void FlipperROSPlugin::Load(gazebo::physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  try {
    FlipperPlugin::Load(_parent, _sdf);
  ...
  this->subReference = this->rosNode->subscribe<
    ...
    >(this->commandSubscriber->GetTopic(), 10,
      boost::bind(&FlipperROSPlugin::SetReference, this, _1));
/*
  this->subForce = this->rosNode->subscribe<
    geometry_msgs::WrenchStamped
    >(this->forceSubscriber->GetTopic(), 10,
      boost::bind(&FlipperROSPlugin::SetForce, this, _1));*/
  ...
  this->services["get_lift_drag_params"] = this->rosNode->advertiseService(
    stream.str(), &FlipperROSPlugin::GetLiftDragParams, this);
  ...
  this->rosPublishConnection = gazebo::event::Events::ConnectWorldUpdateBegin(
        boost::bind(&FlipperROSPlugin::RosPublishStates, this));
}

/////////////////////////////////////////////////
void FlipperROSPlugin::RosPublishStates()
{
...
/////////////////////////////////////////////////
bool FlipperROSPlugin::GetLiftDragParams(
...
GZ_REGISTER_MODEL_PLUGIN(FlipperROSPlugin)
}
